				...
				<div class="contact-block">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
								<input type="number" class="form-control" id="numpessoas" name="numpessoas" placeholder="Contando com você, quantas pessoas irão?" required="required">
							</div>
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<textarea class="form-control" name="message" id="message" placeholder="Deixe aqui sua mensagem aos noivos"></textarea>
							</div>
							<div class="form-group">
